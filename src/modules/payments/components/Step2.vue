<template>
  <div class="my-component">
    <form @submit.prevent="makePayment">
      <div class="mb-3">
        <label for="payment-method" class="col-form-label fw-bold"
          >Seleccione el de su preferencia:</label
        >
        <select
          class="form-select"
      ...
      <div class="mb-5 mt-5" v-if="paymentMethod === 'paypal'">
        ...
        <p>
          ...
          <span class="fw-bold">
            PayPal te cobrará un importe de
            {{
              (total / 4654).toLocaleString("eu-EU", {
                style: "currency",
                currency: "USD",
      ...
      <div v-if="paymentMethod === 'card'" class="mt-1">
        <div class="mb-3">
          ...
          <input
            ...
            v-model="cardName"
          />
          <div class="text-danger fw-normal" v-if="!cardNameOk">
            Recuerde llenar el nombre de su tarjeta
          </div>
        </div>
        <div class="mb-3">
          ...
          <input
            ...
            v-model="cardNumber"
          />
          <div class="text-danger fw-normal" v-if="!cardOk">
            Recerde ingresar un numero de tarjeta válido.
          </div>
        </div>
        <div class="d-md-flex justify-content-between">
          <div class="mb-3 w-45">
            ...
            <input
              ...
              v-model="cvcNumber"
            />
            <div class="text-danger fw-normal" v-if="!cvcOk">
              Recuerde que el CVC es un número positivo de 3 o 4 cifras.
            </div>
          </div>
          <div class="mb-3 w-45">
            ...
            <div class="text-danger fw-normal" v-if="!dateOk">
              La tarjeta ya expiró o no se ingresó su fecha
            </div>
          </div>
        </div>
      </div>
...
const validateData = () => {
  ...
  if (
    !(
      (cvcNumber.value.toString().length === 3 || cvcNumber.value.toString().length === 4) &&
      cvcNumber.value > 0
    )
  ) {
    cvcOk.value = false;
